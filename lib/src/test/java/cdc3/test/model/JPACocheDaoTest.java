...
class JPACocheDaoTest {
	...
	@DisplayName("Verifica el método para eliminar todos los coches")
	@Test
	void testDeleteAll() {
				
		undertest.deleteAll();
		
		assertEquals(undertest.getConcesionario().size(), 0 ,"No se ha borrado al completo");
